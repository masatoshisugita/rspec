...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<aws-sdk>.freeze, [">= 2.0.34", "< 3.0"])
    ...
    s.add_development_dependency(%q<actionmailer>.freeze, [">= 4.2.0"])
    ...
    s.add_dependency(%q<aws-sdk>.freeze, [">= 2.0.34", "< 3.0"])
